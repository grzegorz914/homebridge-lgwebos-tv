...
class LgWebOsSocket extends EventEmitter {
    constructor(config) {
        ...
        this.impulseGenerator.on('heartBeat', () => {
            try {
                    ...
                    case this.softwareInfoId:
                        switch (messageType) {
                            ...
                            case 'error':
                                ...
                                break;
                            default:
                                const debug4 = this.debugLog ? this.emit('debug', this.emit('debug', `Software info received message, type: ${messageType}, id: ${messageId}, data: ${stringifyMessage}`)) : false;
                                break;
                        };
                        break;
